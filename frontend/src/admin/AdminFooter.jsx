      ...
      <div>
        {items.map((item, idx) => (
          <div key={item.id} style={{
            ...
            <span style={{ fontSize: "11px", color: "var(--text-muted)", width: 32, textAlign: "center", fontFamily: "var(--font-mono)" }}>
              {item.type === "link" ? "link" : "text"}
            </span>
            <span style={{ flex: 1, fontSize: "14px", color: "var(--text)" }}>
              {item.label}
              {item.url && <span style={{ marginLeft: "0.5rem", fontSize: "12px", color: "var(--text-muted)", fontFamily: "var(--font-mono)" }}>{item.url}</span>}
            </span>
...
const h1 = { margin: "0 0 0.5rem", fontSize: "22px", fontWeight: 600, color: "var(--text-bright)" };
const sectionTitle = { margin: "0 0 0.75rem", fontSize: "14px", fontWeight: 600, color: "var(--text)" };
const inputStyle = { padding: "0.5rem 0.6rem", background: "var(--bg-highlight)", border: "1px solid var(--border)", borderRadius: "4px", color: "var(--text)", fontFamily: "var(--font-body)", fontSize: "14px", boxSizing: "border-box" };
...
const arrowBtn = { background: "none", border: "none", color: "var(--text-muted)", cursor: "pointer", padding: "0 2px", fontSize: "11px", lineHeight: 1 };
