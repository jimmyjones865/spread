...
const chipStyle = {
  ...
  borderRadius: "4px", padding: "0.2rem 0.5rem", fontSize: "0.875rem",
};
const chipX = {
  background: "none", border: "none", color: "var(--text-muted)",
  cursor: "pointer", padding: 0, fontSize: "0.8125rem",
};
const inputStyle = {
  width: "100%", padding: "0.5rem", background: "var(--bg-highlight)",
  border: "1px solid var(--border)", borderRadius: "4px",
  color: "var(--text)", fontFamily: "var(--font-body)", fontSize: "0.9375rem",
};
const dropdownStyle = {
...
const optionStyle = {
  padding: "0.5rem 0.75rem", cursor: "pointer", fontSize: "0.9375rem",
  color: "var(--text)",
};
